...
public class CSVReader {
    ...
    public CSVReader(String resourceType) {
        this.resourceType = resourceType;
    }

    public void setCSVResourceType(String resourceType) {
        this.resourceType = resourceType;
    }

    private String getResourcePath() {
        File locateFile = new File(this.getClass().getResource("/").getPath());
        File resourceFiles = locateFile.getParentFile().getParentFile().getParentFile();
        return resourceFiles.getPath() +
                File.separator +
                "files" +
                File.separator +
                resourceType +
    ...
    public Map<String, String> findMovieDetailByMovieName(String movieName) {
        ...
        try {
            bufferReader = new BufferedReader(new FileReader(getResourcePath()));
